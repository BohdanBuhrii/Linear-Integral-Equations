...
В ядрах $K_{12}$, $K_{21}$ внаслідок параметризації тачки $x$ та $y$ знаходяться на різних кривих в результаті чого при інтегруванні в них не виникають особливості.

У випадку $K_{11}$, $K_{22}$ обидві точки знаходяться на одній кривій і тому вони мають особливість при $t = \tau$. Для тґого що її позбутись, можна знайти границю цих ядер при $t \rightarrow \tau$ і використати її замість ядра для випадків, коли $t = \tau$. Скористуємось правилом лопіталя і знайдемо границю........
